package com.example.mipicksintentredirectpoc.Utils;
...
public class Utils {
    ...
    public static String dumpIntent(Context context, Intent intent, int indentLevel) {
        if(intent == null) {
...
//        append basic intent information
        sb.append(intent).append("[Action]   ").append(intent.getAction()).append("\n");
//        append categories
...
//        append component
        sb.append(intent).append("[Component]   ").append(intent.getComponent()).append("\n");
//        append Flags
        sb.append(intent).append("[Flags]   ").append(getFlagString(intent.getFlags())).append("\n");
    ...
    private static String dumpBundle(Bundle bundle, int indentLevel) {
        ...
        for (String key : bundle.keySet()) {
            ...
            if (value instanceof Bundle) {
                ...
                sb.append(String.format("%s['%s']: %s\n", indent,key, value != null ? value.toString() : "nu;;"));
            }
        }
        return sb.toString();
    }
